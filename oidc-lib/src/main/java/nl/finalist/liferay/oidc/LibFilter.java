...
public class LibFilter {
    ...
    protected void exchangeCodeForAccessToken(HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            tokenRequest.addHeader("Authorization", "Basic " + generateBasicAuthorizationHeader(oidcConfiguration));
    ...
    private String generateBasicAuthorizationHeader(OIDCConfiguration oidcConfiguration) {
        return new String(Base64.encodeBase64((oidcConfiguration.clientId() + ":" + oidcConfiguration.secret()).getBytes()));
    }
